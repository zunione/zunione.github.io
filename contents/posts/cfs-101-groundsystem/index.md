...
다음 실습은 cFS에 새로운 앱을 추가하여 mission-specific한 cFS 소프트웨어를 만들 수 있는 기반을 다지는 단계이다. 시작이 반이고 가만히 있으면 반이라고 했으니까~😉 CFS-101 수료가 머지않았다!

물론 농담이고 이제 딱 절반 진행하였으니 조금만 더 힘내도록 하자😝